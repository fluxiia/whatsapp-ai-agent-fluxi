"""
Definição das tools OpenAI (function calling) do Sandbox Interno.
Cada tool mapeia para uma chamada no InternalService (shell, file, browser, code).
"""
    ...
    return [
            ...
            "function": {
                ...
                "parameters": {
                    ...
                    "properties": {
                        ...
                        "exec_dir": {
                            "type": "string",
                            "description": "Diretório de trabalho (caminho absoluto). Default: /home/user"
                        },
                        "timeout": {
                            "type": "number",
            ...
            "function": {
                ...
                "parameters": {
                    ...
                    "properties": {
                        "file": {
                            "type": "string",
                            "description": "Caminho absoluto do arquivo (ex: /home/user/script.py)"
                        },
                        "start_line": {
                            "type": "integer",
        ...
        },
        {
            ...
            "function": {
                ...
                "description": (
                    "Verifica a existência e tamanho de um arquivo no sandbox. "
                    "Use enviar_arquivo_whatsapp para enviar o arquivo ao usuário."
                ),
                "parameters": {
                    "type": "object",
                    "properties": {
                        "path": {
                            "type": "string",
                            "description": "Caminho absoluto do arquivo a verificar"
                        }
                    },
                    "required": ["path"]
                }
        ...
        # ══════════════════════════════════════════════════════════
        # BROWSER - Ações GUI (nível pixel via Playwright)
        # ══════════════════════════════════════════════════════════
        {
            "type": "function",
            "function": {
                ...
                "description": (
                    "Executa uma ação GUI no browser via coordenadas de pixel. "
        ...
        },
        {
            ...
            "function": {
                ...
                "description": (
                    "Tira screenshot da página atual no browser. "
                    "Útil para ver o estado visual atual."
                ),
                "parameters": {
                    "type": "object",
                    "properties": {},
        ...
        },
        {
            ...
            "function": {
                ...
                "description": (
                    ...
                    "Mais preciso. Suporta full_page."
                ),
                "parameters": {
                    "type": "object",
                    "properties": {
            ...
            "function": {
                ...
                "parameters": {
                    ...
                    "properties": {
                        ...
                        "x": {"type": "number", "description": "Coordenada X para clicar"},
                        "y": {"type": "number", "description": "Coordenada Y para clicar"}
                    },
                    "required": []
                }
            }
        },
        {
            ...
            "function": {
                ...
                "parameters": {
                    "type": "object",
                    "properties": {
                        "text": {"type": "string", "description": "Texto a preencher"},
                        "selector": {"type": "string", "description": "Seletor CSS do input"},
                        "index": {"type": "integer", "description": "Índice se houver múltiplos inputs"}
                    },
                    "required": ["text"]
                }
            }
            ...
            "function": {
                ...
                "parameters": {
                    ...
                    "properties": {
                        ...
                        "delay": {"type": "number", "description": "Atraso entre teclas em ms"}
                    },
                    "required": ["text"]
                }
            }
        ...
        },
        {
            ...
            "function": {
                ...
                "description": (
                    ...
                    "PREFIRA usar 'label' com o texto exato visível da opção (ex: 'Ordenar por preço: menor para maior'). "
                    "Use 'value' apenas se souber o valor interno do HTML. "
                    "NÃO use 'index' a não ser que saiba exatamente qual posição é (0=primeira, 1=segunda...)."
                ),
                "parameters": {
                    "type": "object",
                    "properties": {
                        "selector": {"type": "string", "description": "Seletor CSS do elemento <select>"},
                        "value": {"type": "string", "description": "Valor interno do option (atributo value do HTML)"},
                        "label": {"type": "string", "description": "Texto visível da opção exatamente como aparece na página (PREFERIDO)"},
                        "index": {"type": "integer", "description": "Posição numérica: 0=primeira opção, 1=segunda, etc. Use somente se não souber o label"}
                    },
                    "required": ["selector"]
                }
            }
        ...
        # ── Browser - Extração de conteúdo ────────────────────────
        {
            "type": "function",
            "function": {
                "name": "sandbox_browser_get_page_state",
                "description": (
                    "**PREFERENCIAL** — Estado completo da página otimizado para LLM. "
                    "Usa Accessibility Tree nativa do browser (como browser-use): compacto, semântico, sem HTML/CSS/scripts. "
                    "Retorna: URL, título, conteúdo legível, e lista de elementos interativos numerados [N] "
                    "(botões, links, inputs, checkboxes, etc.) para navegação via sandbox_browser_click_index. "
                    "Use SEMPRE após navegar para uma nova página — evita passar HTML cru ao LLM."
                ),
                "parameters": {
                    "type": "object",
                    "properties": {
                        "max_content": {
                            "type": "integer",
                            "description": "Tamanho máximo do conteúdo retornado em caracteres (default: 6000)"
                        }
                    },
                    "required": []
                }
        ...
        },
        {
            "type": "function",
            "function": {
                "name": "sandbox_browser_click_index",
                "description": (
                    "Clica no N-ésimo elemento interativo da página usando o índice retornado por "
                    "sandbox_browser_get_page_state ou sandbox_browser_get_elements. "
                    "Mais confiável que selectors CSS quando elementos não têm ID."
                ),
                "parameters": {
                    "type": "object",
                    "properties": {
                        "index": {
                            "type": "integer",
                            "description": "Índice [N] do elemento a clicar (da lista interactive_elements)"
                        }
                    },
                    "required": ["index"]
                }
        ...
        },
        {
            ...
            "function": {
                ...
                "parameters": {
                    "type": "object",
                    "properties": {
                        "outer": {"type": "boolean", "description": "Se true, retorna outerHTML"}
                    },
                    "required": []
                }
            }
        },
        {
            ...
            "function": {
                ...
                "description": (
                    "Converte o conteúdo da página para Markdown usando Readability. "
        ...
        },
        {
            ...
            "function": {
                ...
                "description": "Obtém informações do browser (URL atual, viewport, etc.).",
                "parameters": {"type": "object", "properties": {}, "required": []}
            }
        },
        # ── Browser - Navegação ──────────────────────────────────
        ...
        # ── Browser - CAPTCHA / Interação humana ─────────────────
        {
            "type": "function",
            "function": {
                "name": "sandbox_browser_detect_captcha",
                "description": (
                    "Detecta se a página atual tem CAPTCHA (reCAPTCHA, hCaptcha, Cloudflare, bot detection). "
                    "Use após navegar para uma página que pode ter CAPTCHA."
                ),
                "parameters": {"type": "object", "properties": {}, "required": []}
            }
        },
        {
            "type": "function",
            "function": {
                "name": "sandbox_browser_wait_user",
                "description": (
                    "Pausa a execução e aguarda interação manual do usuário. "
                    "Use quando detectar CAPTCHA ou qualquer situação que exija ação humana."
                ),
                "parameters": {
                    "type": "object",
                    "properties": {
                        "seconds": {"type": "number", "description": "Segundos para aguardar (default: 30)"},
                        "mensagem": {"type": "string", "description": "Mensagem opcional sobre o que está aguardando"}
                    },
                    "required": []
                }
            }
        ...
        # ══════════════════════════════════════════════════════════
        {
            ...
            "function": {
                ...
                "description": (
                    "Executa código Python com persistência de sessão (kernel Jupyter-like). "
                ...
                "parameters": {
                    ...
                    "properties": {
                        ...
                        "session_id": {"type": "string", "description": "ID da sessão para manter estado entre execuções"},
                        "kernel_name": {"type": "string", "description": "Nome do kernel: 'python3'"}
                    },
                    "required": ["code"]
                }
            }
        },
        {
            ...
            "function": {
                ...
                "description": "Obtém informações sobre kernels disponíveis.",
                "parameters": {"type": "object", "properties": {}, "required": []}
            }
        },
        {
            ...
            "function": {
                ...
                "description": "Lista todas as sessões Python ativas.",
                "parameters": {"type": "object", "properties": {}, "required": []}
            }
        },
        {
            ...
            "function": {
                ...
                "description": "Remove/limpa uma sessão Python específica para liberar recursos.",
                "parameters": {
                    "type": "object",
                    "properties": {
                        "session_id": {"type": "string", "description": "ID da sessão a remover"}
                    },
                    "required": ["session_id"]
                }
            }
            ...
            "function": {
                ...
                "parameters": {
                    ...
                    "properties": {
                        ...
                        "timeout": {"type": "integer", "description": "Timeout em segundos (default: 60)"},
                        "session_id": {"type": "string", "description": "ID da sessão para persistência"},
                        "files": {"type": "object", "description": "Arquivos auxiliares: {'filename.json': 'conteúdo', ...}"},
                        "stdin": {"type": "string", "description": "Input stdin para o processo Node.js"}
                    },
                    "required": ["code"]
                }
            }
            ...
            "function": {
                ...
                "parameters": {
                    ...
                    "properties": {
                        ...
                        "language": {"type": "string", "description": "Linguagem: 'python', 'javascript', etc."},
            ...
            "function": {
                ...
                "parameters": {
                    ...
                    "properties": {
                        "file_path": {
                            "type": "string",
                            "description": "Caminho completo do arquivo no sandbox"
                        },
                        "filename": {
                            "type": "string",
        ...
        },
        {
            ...
            "function": {
                ...
                "description": (
                    "Tira um screenshot do browser do sandbox e envia diretamente ao usuário via WhatsApp. "
                ...
                "parameters": {
                    ...
                    "properties": {
                        "tipo": {
                            "type": "string",
                            "enum": ["tela", "pagina"],
                            "description": "Tipo: 'tela' (display completo) ou 'pagina' (apenas a página do browser)"
                        },
                        "full_page": {
                            "type": "boolean",
